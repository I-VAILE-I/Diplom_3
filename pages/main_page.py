...
class MainPage(BasePage):
    ...
    def click_on_element_text_personal_cabinet(self):
        self.click_on_element(MainPageLocators.personal_cabinet_text)

    @allure.step('Кликаем на текст "Личный кабинет"')
    def click_on_text_personal_cabinet(self):
        self.standard_click_on_element(MainPageLocators.personal_cabinet_text)
    ...
    def click_on_close_cross(self):
        self.standard_click_on_element(MainPageLocators.cross_to_close)
    ...
    @allure.step('Ждем когда можно будет кликнуть на крести')
    def wait_to_click_close_cross(self):
        self.wait_to_visible_on_element(MainPageLocators.cross_to_close)
    ...
    def wait_to_be_invisible_loading_screen(self):
        self.wait_to_invisibil_on_element(MainPageLocators.loading_screen_one)

    @allure.step('Ждем открытия главной страницы')
    def wait_to_be_invisible_second_loading_screen(self):
        self.wait_to_invisibil_on_element(MainPageLocators.loading_screen_two)
